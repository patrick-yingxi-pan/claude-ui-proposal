...
[`shared-resource-coordination.md:230`](shared-resource-coordination.md)). In a
...
real filesystem/toolchain ([`capability-broker-architecture.md:294`](capability-broker-architecture.md)).
...
([`capability-broker-architecture.md:187`](capability-broker-architecture.md)).
...
co-located-only ([`capability-broker-architecture.md:222`](capability-broker-architecture.md)),
...
([`capability-broker-architecture.md:288`](capability-broker-architecture.md);
...
opens by demolishing ([`shared-resource-coordination.md:17`](shared-resource-coordination.md),
...
[`shared-resource-coordination.md:79`](shared-resource-coordination.md)). So a Project
...
[`shared-resource-coordination.md:308`](shared-resource-coordination.md)) and
**re-reasons** — "conflict is a question, not an abort"
([`shared-resource-coordination.md:159`](shared-resource-coordination.md)) becomes the
default inter-agent protocol. And the **consent gate is the serialization gate**
([`shared-resource-coordination.md:178`](shared-resource-coordination.md)): the moment
...
item 3, [`shared-resource-coordination.md:230`](shared-resource-coordination.md)) is
...
[`shared-resource-coordination.md:198`](shared-resource-coordination.md)). And
...
([`capability-broker-architecture.md:133`](capability-broker-architecture.md)), and
...
- **Attenuation is already half-present.** `AgentCapability.scopes`
  ...
  ([`../contract/contexts.ts:68`](../contract/contexts.ts)) are subset-grants the
...
- **Promotes the coordination doc's hardest residue to the center.** Multi-principal
  ...
  [`shared-resource-coordination.md:230`](shared-resource-coordination.md)) is the
